...
class Member:
    ...
    def get_transaction(self, account_id, transaction_id, key_level):
        return self.client.get_transaction(account_id, transaction_id, key_level)

    def get_transactions(self, account_id, key_level, limit, offset=None):
        return self.client.get_transactions(account_id, key_level, limit, offset)
    ...
    def remove_aliases(self, alias_list: List[Alias]):
        ...
        for alias in alias_list:
            alias_operations = MemberAliasOperation(alias_hash=utils.hash_alias(alias))
    ...
    def get_transfers(self, limit: int, offset: Optional[str] = None, token_id: Optional[str] = None):
    ...
    def create_customization(self, colors=None, display_name=None, logo=None, consent_text=None):
        if colors is None:
            colors = []
        return self.client.create_customization(colors, display_name, logo, consent_text)
